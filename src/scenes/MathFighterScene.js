...
export default class MathFighterScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.enemy = this.physics.add.sprite(
            this.gameHalfWidth + 150,
            this.gameHalfHeight - 120, 'enemy'
        ).setBounce(0.2).setOffset(20, -10).setFlipX(true)
        this.physics.add.collider(this.player, tile)
        this.physics.add.collider(this.enemy, tile)
        this.createAnimnation()
        this.createButton()

        this.scoreLabel = this.add.text(10, 10, 'Score:', { backgroundColor: 'black' }).setDepth(1)
